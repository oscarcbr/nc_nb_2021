...
#Paths NB.noMitchnd.KEql10
raw_cnts='data/NB.noMitchnd.d/KEql10.d/NB.noMitchnd.KEql10.cnts.csv'
clstrs_PAGODA='data/NB.noMitchnd.d/KEql10.d/NB.noMitchnd.KEql10.clstrsLbld.tsv'
depot_prefix='NB.noMitchnd.KEql10'
...
pagoda_tSNEFl='data/NB.noMitchnd.d/KEql10.d/NB.noMitchnd.KEql10.tsne.tsv'
flippingTsne=FALSE
