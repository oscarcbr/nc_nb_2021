...
#Replace the next line by each sample for mouse adrenal gland: {SS2_17_343, SS2_17_344, SS2_18_111, SS2_18_114, SS2_18_116}
smpl="SS2_17_343"
#GTF file
gtfFl="mm10.genecodeV18Comp.ERCCYFPiCre.cfflinks.gnNms.biotyp.gtf"
...
genDir="mapping.d/STAR.d/${smpl}.d"
mkdir $genDir
cd $genDir
